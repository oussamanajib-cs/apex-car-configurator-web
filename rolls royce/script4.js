...
function updateCar(){
    ...
    // Image principale
    carPrincipale.src = `../pics/cars/rolls roys/${extColor}/${wheelColor}/1.png`;
    ...
    imgs.forEach((imgBox, index) => {
        imgBox.querySelector("img").src =`../pics/cars/rolls roys/${extColor}/${wheelColor}/${smallImages[index]}`;
    });
}
...
function updateInt(){
    intImg.src = `../pics/cars/rolls roys/${intColor}.png`;
}
